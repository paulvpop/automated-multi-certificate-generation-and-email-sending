...
Step 1) Create a/multiple template certificate(s) using any image/slide editing software of your choice. Canva is easiest choice as they have some pre-made certificate templates that are free to you, which you can modify. 

Step 2) Download the temeplate and save it to a folder titled your event name (or simply save it to that folder if you're using an offline editing application).

Step 3) Use this R script (follow the instructions there and edit it according to your requirements): 
